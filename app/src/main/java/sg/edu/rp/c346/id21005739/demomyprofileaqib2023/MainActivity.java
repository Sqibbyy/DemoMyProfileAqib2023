package sg.edu.rp.c346.id21005739.demomyprofileaqib2023;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        // Step 1a: Get the user inputs from the EditText and store it in a variable
    ...
    protected void onResume() {
        ...
        String strName = prefs.getString("name", "Joshua");
